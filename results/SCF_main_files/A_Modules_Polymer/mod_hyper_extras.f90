...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!   
!   Here the reading of the topology and weight are done via routines
!   "Read_Topology_Data" and "Read_Weights" respectivelly.
!   Additionally "Initialize_Density" can be used to generate some 
!   initial geometries.
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
