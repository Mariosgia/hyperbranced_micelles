...
angles_id=[0,0,1] # ['A-D-B','A-D-B','B-D-B']
...
## Apply the COSINE potential 
cosinesq = hoomd.md.angle.CosineSquared()
cosinesq.params['A-D-B'] = dict(k=100.0, t0=2.5/3.0*math.pi)
cosinesq.params['B-D-B'] = dict(k=100.0, t0=2.0/3.0*math.pi)
